...
const SignIn: React.FC<SignInProps> = ({ onSignIn, onBackToLanding, onSwitchToRegister, loading }) => {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-cyan-400/20 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Sign in to access your MapMyWork dashboard</p>
          </div>
